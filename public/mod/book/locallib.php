 ...
 * @return int|bool
 */
function mod_book_get_chapter_to_display(int $bookid, array $chapters): int|bool {
    $lastuserviewedchapterid = mod_book_get_last_viewed_chapter($bookid);
 ...
 * @return bool
 */
function mod_book_get_last_viewed_chapter($bookid) {
    global $DB, $USER;
