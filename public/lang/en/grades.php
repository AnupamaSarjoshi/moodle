...
$string['enableoutcomes_help'] = 'If enabled, teachers can define course-level learning outcomes and tag activities to them. Students see which outcomes each activity supports. Scales are no longer required when creating a learning outcome.';
...
$string['importcustom'] = 'Import as custom learning outcomes (only this course)';
...
$string['importoutcomes_help'] = 'Learning outcomes can be imported via CSV file with format as for the export learning outcomes CSV file.';
...
$string['importstandard'] = 'Import as standard learning outcomes';
...
$string['nooutcomes'] = 'Outcome items must be linked to a course learning outcome, but there are no learning outcomes for this course. Would you like to add one?';
...
$string['noscales'] = 'This outcome is linked to a scale, but no scales are available. Would you like to add one?';
...
$string['outcomescourse'] = 'Assessment outcomes used in course';
...
$string['outcomescustom'] = 'Custom learning outcomes';
$string['outcomesdisabled'] = 'Learning outcomes are not enabled';
$string['outcomeshortname'] = 'Short name';
$string['outcomesstandard'] = 'Standard learning outcomes';
$string['outcomesstandardavailable'] = 'Available standard outcomes';
$string['outcomestandard'] = 'Standard learning outcome';
$string['outcomestandard_help'] = 'A standard learning outcome is available site-wide, for all courses.';
